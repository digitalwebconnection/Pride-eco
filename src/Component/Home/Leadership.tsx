...
const Leadership = () => {
  return (
    <section className="relative py-16 md:py-32 bg-slate-50 overflow-hidden">
          ...
          <div className="lg:col-span-5 relative">
            ...
            >
              ...
              <motion.div
                ...
                className="absolute -bottom-10 right-0 md:right-10 bg-white shadow-2xl rounded-3xl p-6 border border-slate-100"
              >
          ...
          <div className="lg:col-span-7 space-y-8">
            <div>
              ...
              <motion.h2
                ...
                className="font-serif text-4xl md:text-5xl font-extrabold text-slate-900 leading-tight"
              >
            ...
            <motion.div
              ...
              className="space-y-4"
            >
              <h3 className="font-serif text-2xl font-bold text-slate-800 flex items-center gap-3">
                Mr. Shiva Dixit
